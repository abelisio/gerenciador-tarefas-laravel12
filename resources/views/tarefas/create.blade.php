...
<form class="row g-3" action="{{route('tarefas.store')}}" method="post">
  ...
  <div class="mb-3">
    ...
    <input class="form-control " type="text" id="titulo" name="titulo" placeholder="Título da tarefa" require>
  </div>
  <div class="mb-3">
...
<select class="form-select form-select-lg mb-1" id="responsavel" name="responsavel" aria-label="Large select example" require>
...
<select class="form-select form-select-lg mb-3" id="situação" name="situação" aria-label="Large select example" require>
  ...
  <input type="date" class="form-control" data-inputmask-alias="datetime" name="deadline" id="deadline" require><br<br>
