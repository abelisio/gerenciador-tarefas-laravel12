        ...
        <div class="col-md-18">
            <div class="row g-2 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <strong class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: #edeff0;">Editar
                        Tarefa</strong>
                    @if ($errors->any())
                    ...
                    <form action="{{ route('tarefas.update', ['tarefa' => $tarefa->id]) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control " type="text" id="titulo" name="titulo" value="{{ $tarefa->titulo }}"
                                require>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="col-md">
                                <div class="mb-3">
                                    ...
                                    <select name="responsavel" class="form-control">
                                        ...
                                        <option value="Han Solo" {{ $tarefa->responsavel == 'Han Solo' ? 'selected' : '' }}>
                                            Han Solo</option>
                                        <option value="Yoda" {{ $tarefa->responsavel == 'Yoda' ? 'selected' : '' }}>Yoda
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md">
                                    <div class="form-floating">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-lg" id="prioridade" name="prioridade"
                                                required>
